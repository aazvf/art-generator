...
export default {
    methods: {
        generateNewDesign() {
            ...
            this.design.cropRotations = [0, 90, 180, 270];
            ...
            this.design.bigMotifLayer.motif.scaleUp = 2.5;
            ...
            for (let layerKey = 0; layerKey < layers.length; layerKey++) {
                ...
                for (let l = 0; l < layers[layerKey].element.repeatLimit; l++) {
                    layers[layerKey].backgrounds.push(
                        this.generateMotifBackgroundPoints(1, 2, 20)
                    );
                }
        ...
        generateLayer(l, colorHues) {
            ...
            let charCount = this.arrayRandom(1, 1, 1, 1, 2, 2, 2, 3);
